...
PATROL_FAILED_CORRIDOR_START_GRACE_M="${PATROL_FAILED_CORRIDOR_START_GRACE_M:-0.25}"
...
echo "[run_nav2] failed_corridor=${PATROL_FAILED_CORRIDOR_ENABLED} radius=${PATROL_FAILED_CORRIDOR_RADIUS_M}m behind=${PATROL_FAILED_CORRIDOR_BEHIND_M}m ahead=${PATROL_FAILED_CORRIDOR_AHEAD_M}m ttl=${PATROL_FAILED_CORRIDOR_TTL_SEC}s max=${PATROL_FAILED_CORRIDOR_MAX} start_grace=${PATROL_FAILED_CORRIDOR_START_GRACE_M}m"
...
NAV2_ARGS=(
  ...
  "patrol_failed_corridor_start_grace_m:=${PATROL_FAILED_CORRIDOR_START_GRACE_M}"
