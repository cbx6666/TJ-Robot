...
if ! grep -Fq "export TURTLEBOT3_MODEL=waffle" "${HOME}/.bashrc"; then
...
for pkg in gazebo_ros slam_toolbox turtlebot3_gazebo turtlebot3_description xacro depth_image_proc pointcloud_to_laserscan; do
