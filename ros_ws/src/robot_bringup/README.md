...
| 路径 | 内容 |
|------|------|
| `launch/` | 各功能 launch：`slam_laser`、`coverage_patrol`、`nav2_coverage_patrol`、`rgbd_to_scan`、`bringup`、`slam_rgbd*` 等 |
| `config/` | `mapper_params_online_async_*.yaml`（slam_toolbox）、`nav2_params_slam.yaml`、`test1.rviz`、`cartographer/` |
...
| `nav2_params_slam.yaml` | 与 slam 地图配合的 Nav2 |
