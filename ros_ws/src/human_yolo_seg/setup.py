...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "annotate_saved_map_person_overlay = human_yolo_seg.tools.annotate_saved_map_person_overlay:main",
            "snapshot_person_regions_from_cloud = human_yolo_seg.tools.snapshot_person_regions_from_cloud:main",
            "scan_map_colored_cloud_node = human_yolo_seg.nodes.scan_map_colored_cloud_node:main",
            "azimuth_union_node = human_yolo_seg.nodes.azimuth_union_node:main",
            "person_azimuth_markers_node = human_yolo_seg.nodes.person_azimuth_markers_node:main",
        ],
    },
)
